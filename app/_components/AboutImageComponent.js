...
function AboutImageComponent() {
  return (
    <div className="pt-6  backdrop-blur-3xl  px-6      lg:pt-20  xl:pt-28  ">
      ...
      <div data-aos="fade-up" className="flex flex-col pb-10 sm:pb-28 items-center">
        ...
        <div className="flex flex-wrap items-center text-[1.7rem] sm:text-[1.9rem] lg:text-[2.1rem] gap-4 md:text-4xl  ">
          ...
          <i className="devicon-nextjs-plain dark:hover:text-slate-400 transition-all duration-300 hover:text-black hover:scale-110"></i>
          ...
          <i className="devicon-github-original dark:hover:text-slate-400 transition-all duration-300 hover:text-[#181717] hover:scale-110"></i>
